...
namespace TestApp.Provider
{
    public class MyCustomHelpProvider : IHelpProvider
    {
        ...
        public MyCustomHelpProvider(IStringLocalizerFactory stringLocalizerFactory, AppSettings appSettings, string appName = null)
        {
            _appName = appName;
        ...
        {
            return _appName ??= _appHelpSettings.GetAppName();
        }
